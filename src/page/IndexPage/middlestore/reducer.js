...
import { SAVE_ALL_MIDDLE, SAVE_NEW_MIDDLE, SAVE_UPDATE_MIDDLE, SAVE_DETAIL_MIDDLE, SAVE_MULTIPLE_MIDDLE, SAVE_FILTER_MIDDLE } from "./constants";
    ...
    return produce(state, (draft) => {
        switch (action.type) {
            ...
            case SAVE_MULTIPLE_MIDDLE:
                ...
                break;
            case SAVE_FILTER_MIDDLE:
                draft.filterMiddle = action.payload
                break;
            default:
                return state;
        }
