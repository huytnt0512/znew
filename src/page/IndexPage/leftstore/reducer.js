...
import { SAVE_ALL_LEFT, SAVE_NEW_LEFT, SAVE_UPDATE_LEFT, SAVE_DETAIL_LEFT, SAVE_MULTIPLE_LEFT, SAVE_FILTER_LEFT } from "./constants";
    ...
    return produce(state, (draft) => {
        switch (action.type) {
            ...
            case SAVE_MULTIPLE_LEFT:
                ...
                break;
            case SAVE_FILTER_LEFT:
                draft.filterLeft = action.payload
                break;
            default:
                return state;
        }
